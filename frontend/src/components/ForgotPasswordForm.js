  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative">
        <input
          type="email"
          className={`w-full border rounded-3xl px-3 pt-5 pb-2 focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 bg-white dark:bg-gray-800 text-gray-700 dark:text-white border-gray-300 dark:border-gray-600 transition-all peer`}
          value={email}
